...
- Functional outline and optional auto-capture candidate.
...
### S33 - Functional Outline And Auto-Capture Candidate

Deliverables:

- Convert static outline guidance into functional quality guidance:
  - move closer
  - move farther
  - align bottle
  - adjust downward phone angle
  - wrong side warning
- Use red/orange/green state only when the detection is reliable.
- Add auto-lock/auto-capture only as a gated candidate.
